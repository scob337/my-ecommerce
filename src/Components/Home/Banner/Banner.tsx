    ...
    return (
        <article className="grid grid-cols-1 lg:grid-cols-2 ">
            <article className="col-span-1 h-[90vh] relative mr-1">
                ...
                />
                <article className="absolute inset-0 bg-black bg-opacity-50 hover:bg-opacity-70 transition-all flex flex-col justify-center items-start p-4">
            ...
            <article className="col-span-1 grid grid-rows-2 gap-2 h-full">
                <article className="grid grid-cols-2 gap-2 h-full">
                    <article className="bg-cover bg-center relative min-h-[300px] max-h-[460px]
                    
                    " style={{ backgroundImage: "url('https://images.unsplash.com/photo-1668408333255-934142993824?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bWVuJUUyJTgwJTk5cyUyMGZhc2hpb258ZW58MHx8MHx8fDA%3D')" }}>
                        <article className="bg-black bg-opacity-50 hover:bg-opacity-70 transition-all text-white h-full flex flex-col justify-center items-start p-2">
