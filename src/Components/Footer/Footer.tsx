                    ...
                    <article className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <article>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li>
                                    <a href="#" className="hover:underline">Orders Tracking</a>
                                </li>
                                <li>
                        ...
                        <article>
                            ...
                            <article className='w-[90vw]  md:w-full'>
                                ...
                                <ul className="text-gray-500 dark:text-gray-400 font-medium w-full">
                                    <li className="mb-4  ring-1 ring-[#ccc] rounded-3xl p-1 flex w-[100%] justify-between">
                                        <input type="text" className='outline-none bg-transparent pl-2 w-[55%]' placeholder='Email' />
                                        <button className='bg-red-600 p-2 rounded-3xl text-white w-[40%]'>Subscribe</button>
                                    </li>
