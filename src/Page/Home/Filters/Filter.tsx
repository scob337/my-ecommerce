...
export default function Filter() {
    ...
    return (
        <article className="min-h-[100vh] flex flex-col gap-3">
            <article className="flex flex-col lg:justify-center w-full pt-10 lg:flex-row gap-3">
                <h1
                ...
                <article className="flex gap-2 lg:gap-4 p-1 justify-center w-full lg:w-1/2 h-fit">
                    {ButtonsData.map((el) => (
                        <button
            ...
            <article className="flex gap-1 flex-wrap justify-center w-full h-full">
